...
internal static partial class AuthEndpoints
{
    ...
    public static IEndpointRouteBuilder MapAuth(this IEndpointRouteBuilder app)
    {
        ...
        app.MapPost("/api/auth/connect", async (HttpContext ctx, ITokenStore tokens, IReviewAuth review, IAppStateStore stateStore, IConfigStore config, IViewerLoginProvider viewerLogin, IGitHubCredentialHealth credentialHealth, ILogger<Category> log, CancellationToken ct) =>
        {
            JsonDocument doc;
            try
            {
...
#pragma warning restore CA1308
        ...
        app.MapPost("/api/auth/connect/commit", async (ITokenStore tokens, IAppStateStore stateStore, IConfigStore config, IViewerLoginProvider viewerLogin, IGitHubCredentialHealth credentialHealth, ILogger<Category> log, CancellationToken ct) =>
        {
