...
public class PrDetailLoaderTests
{
    ...
    private static PrDetailDto MakeDetail(string headSha = "head1", string baseSha = "base1", bool isMerged = false) =>
        new(
            Pr: new Pr(
                ...
                Body: "body",
                Author: "alice",
                State: isMerged ? PrState.Merged : PrState.Open,
                HeadSha: headSha,
                BaseSha: baseSha,
                HeadBranch: "feat/x",
                BaseBranch: "main",
    ...
    public async Task LoadAsync_returns_existing_realKey_snapshot_when_pollKey_lags_real_head()
    {
        ...
        var review = new FakePrDetailReviewService();
        review.DefaultPollResponse = new ActivePrPollSnapshot("head-fresh", "base1", "MERGEABLE", PrState.Open, 0, 0);
        ...
        review.DefaultPollResponse = new ActivePrPollSnapshot("head-old", "base1", "MERGEABLE", PrState.Open, 0, 0);
