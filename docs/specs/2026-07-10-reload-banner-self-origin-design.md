...
- **[Defer] Review-submit (batch) self-banner** — #764. The same defect on the `DraftSubmitted`
...
- **[Defer] Net by comment id** — #765. The nudge-safe replacement for G's count-based netting,
