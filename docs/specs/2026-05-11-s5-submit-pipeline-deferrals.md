...
### [Defer] The `foreign-pending-review-prompt` and `stale-commit-oid` dialog states get placeholder UI in PR4; the full ForeignPendingReviewModal + StaleCommitOidBanner land in PR5
