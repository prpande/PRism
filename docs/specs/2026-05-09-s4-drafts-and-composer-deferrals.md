...
- **Tested by:** `frontend/__tests__/hooks/useFirstActivePrPollComplete.test.tsx` (Task 41 Step 2) covers `BeforeFirstPoll_ReturnsFalse`, `AfterFirstPoll_ReturnsTrue`, `PrRefChange_ResetsToFalse` plus an `OtherPrRef_Ignored` mirror of PR4's pattern.
