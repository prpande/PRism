...
- **Tracker:** #374 (this slice — P1b-1, correctness/functionality). **Split-out:** #397 (file-backed `IAiCache` + per-PR context artifact + measured prompt-cache hit + identity-scoped cache invalidation — *optimization*, deferred, the measured-hit blocked on #379).
