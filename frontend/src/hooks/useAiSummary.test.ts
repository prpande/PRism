...
describe('useAiSummary', () => {
  ...
  it('stays idle until subscribed', async () => {
    ...
    expect(result.current).toEqual({ summary: null, loading: false, error: false, isStale: false, regenerating: false, regenerateError: false, regenerate: expect.any(Function) });
