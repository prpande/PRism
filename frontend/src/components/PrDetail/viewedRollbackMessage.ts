...
// A 409 means the head advanced under the mark, which a reload recovers, so it gets
// recovery-shaped copy instead of naming the file the user can no longer mark.
