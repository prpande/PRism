...
// Harness exercising focus management, the Tab focus-trap, and the ARIA contract
// (merged here from the former frontend/__tests__/Modal.test.tsx). The Esc-closes
// and closed-renders-nothing cases from that file were assertion-identical to the
// 'calls onClose on Escape by default', 'suppresses Escape when disableEscDismiss',
// and 'renders nothing when closed' cases above, so they were not duplicated.
function Harness({
  defaultFocus,
  disableEscDismiss,
  onClose,
