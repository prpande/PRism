...
| File | Contents |
|------|----------|
| [`v2-ai-effort.md`](.ai/docs/v2-ai-effort.md) | **Read first for AI work** — the AI seams/effort, where work lands (now `main`; `V2` branch retired), what's shipped, substrate facts, cross-cutting gotchas; points to the backlog/epic |
